...
Using python, loaded the data fro the following cleaning and wrangling activities:

1.Renamed the columns
2. Changed the datatype of the Activity_Period column from integer to string
3. Extracted the Year and Month columns from the Activity_Period column
4. Dropped null values (54 ROWS AFFECTED)
5. Saved and exported as a csv file to be loaded in MSSQL
*/
